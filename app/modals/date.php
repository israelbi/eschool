...
<div class="modalShow" id="sortDate" style="display:block;">
	...
	<div class="modalShowBox" style="margin: 5% auto;width:60%;">
		<div class="modal-header " id="clb" style="background-color: #007baa;">
            ...
            <div style="	height: 300px;overflow-y:scroll" id="list_paid">
            <div  style="width:100%;">
               <div class="modal-header"style="width:100%;">
                    <h2>School : Institut Berce</h2>
               </div>
               <div style="padding:10px 0px;">
                    <h5 style="display:block;">Payment On date <?php echo $_GET['search_date'];?></h5>
           ...
           <div class="modal-footer">
                <a  class="button text-white col-lg-3" onclick="printEl('list_paid')">
